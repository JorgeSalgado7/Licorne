				...
				<div className='footer '>
					...
					<div className="footer__inferior">
						...
						<div className="container">
							...
							<div className="footer__inferior__siguenos">
								<h1>Síguenos</h1>

								<div className="footer__inferior__siguenos__redes">
									<div className="footer__inferior__siguenos__redes__redesImagenes">
							...
							<div className="footer__inferior__trabajamos">
